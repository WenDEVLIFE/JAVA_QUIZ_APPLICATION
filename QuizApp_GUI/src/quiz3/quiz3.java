...
public class quiz3 extends  quiz1  {
	...
	public quiz3() throws IOException {
		...
		JRadioButton rdbtnNewRadioButton = new JRadioButton("RAM");
		...
		JRadioButton rdbtnNewRadioButton_2 = new JRadioButton("PSU");
		...
		JLabel lblNewLabel = new JLabel("3. Brain of the Computer");
		lblNewLabel.setBounds(19, 11, 359, 37);
